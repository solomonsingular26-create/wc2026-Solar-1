/* ===================================================================
   ...
   (seeding removed July 8, 2026 — DB is live and locked).
   =================================================================== */
...
/* seedIfEmpty was REMOVED (July 8, 2026).
   The database is fully seeded and results are locked by Firestore rules.
   The old function once re-seeded blank fixtures over real results when a
   client answered the "is the DB empty?" check from an empty local cache. */
